...
위의프로젝트를 클론하여 git log 하여 확인 한 결과,
shooting 과 관련된 커밋이 총 3개였다. 
세개의 내용을 확인 후 버그를 수정하면 되지 않을까. 
세개 중 가장 유력한 커밋은 you get 200  Quatloos for shooting a big flying saucer 이라고 생각한다.
### 힌트
